        ...
        <div class="col-lg-4">
            <section class="card">
                <header class="card-header">
                    <h2 class="card-title">Edit Insurance</h2>
                </header>
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('insurance/update/' . $insurance['insurance_id']) ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="short_code" class="form-control"
                                   value="<?= old('short_code', $insurance['short_code']) ?>" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Current Icon</label><br>
                            <?php if ($insurance['icon']): ?>
                                <img src="<?= base_url('uploads/insurances/' . $insurance['icon']) ?>" width="50">
                            <?php else: ?>
                                <span>No icon</span>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control"><?= old('description', $insurance['description']) ?></textarea>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Status</label>
                            <select name="status" class="form-control">
                                <option value="1" <?= $insurance['status'] ? 'selected' : '' ?>>Active</option>
                                <option value="0" <?= !$insurance['status'] ? 'selected' : '' ?>>Inactive</option>
                            </select>
                        </div>

                        <div class="d-grid">
                            <button type="submit" class="btn btn-warning">
                                <i class="fas fa-edit"></i> Update Insurance
                            </button>
                        </div>
