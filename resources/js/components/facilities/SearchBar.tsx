...
export const SearchBar: React.FC<SearchBarProps> = ({
    ...
    const qualityOptions = [
        ...
        { value: 'level-1', label: 'Safe Care Level 1 - Basic' },
        { value: 'level-2', label: 'Safe Care Level 2 - Standard' },
        { value: 'level-3', label: 'Safe Care Level 3 - Good' },
        { value: 'level-4', label: 'Safe Care Level 4 - Excellent' },
